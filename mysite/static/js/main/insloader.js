...
var _2={"af":"insui-lang-af.js","ar":"insui-lang-ar.js","bg":"insui-lang-bg.js","ca":"insui-lang-ca.js","cs":"insui-lang-cs.js","cz":"insui-lang-cz.js","da":"insui-lang-da.js","de":"insui-lang-de.js","el":"insui-lang-el.js","en":"insui-lang-en.js","es":"insui-lang-es.js","fr":"insui-lang-fr.js","it":"insui-lang-it.js","jp":"insui-lang-jp.js","nl":"insui-lang-nl.js","pl":"insui-lang-pl.js","pt_BR":"insui-lang-pt_BR.js","ru":"insui-lang-ru.js","sv_SE":"insui-lang-sv_SE.js","tr":"insui-lang-tr.js","zh_CN":"insui-lang-zh_CN.js","zh_TW":"insui-lang-zh_TW.js"};
var _3={};
function _4(_5,_6){
var _7=false;
...
var _13=_1[_11];
var _14="loading";
var _15=(insloader.css&&_13["css"])?"loading":"loaded";
if(insloader.css&&_13["css"]){
if(/^http/i.test(_13["css"])){
var url=_13["css"];
}else{
var url=insloader.base+"themes/"+insloader.theme+"/"+_13["css"];
}
_c(url,function(){
_15="loaded";
...
var url=insloader.base+"plugins/"+_13["js"];
}
_4(url,function(){
_14="loaded";
if(_14=="loaded"&&_15=="loaded"){
...
if(insloader.locale&&_1a==true&&_2[insloader.locale]){
var url=insloader.base+"locale/"+_2[insloader.locale];
_9(url,function(){
_1c();
});
}else{
...
insloader={modules:_1,locales:_2,base:".",theme:"default",css:true,locale:null,timeout:2000,load:function(_1f,_20){
if(/\.css$/i.test(_1f)){
if(/^http/i.test(_1f)){
_c(_1f,_20);
}else{
_c(insloader.base+_1f,_20);
}
}else{
if(/\.js$/i.test(_1f)){
if(/^http/i.test(_1f)){
...
var m=src.match(/insloader\.js(\W|$)/i);
if(m){
insloader.base=src.substring(0,m.index);
}
}
window.using=insloader.load;
if(window.jQuery){
jQuery(function(){
insloader.load("parser",function(){
jQuery.parser.parse();
});
});
}
